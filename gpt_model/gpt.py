...
n_layer = 6
dropout = 0.2
model_save_path = "/data3/home/avneeshg/Final_year_project/model/gpt_model.pt"
...
# start_text = " This is a car "
start_text = str(input("Enter the starting text: "))
context = torch.tensor([stoi[c] for c in start_text], dtype=torch.long, device=device).unsqueeze(0)
# print(encode(start_text))
print(torch.tensor(encode(start_text), dtype=torch.long))
